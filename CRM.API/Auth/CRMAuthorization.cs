...
namespace CRM.API.Auth
{
    public class CRMAuthorization
    {
        ...
        public CRMAuthorization(RequestDelegate next)
        {
            _next = next;
        }
    ...
    public static class CRMAuthorizationExtensions
    {
        public static IApplicationBuilder UseCRMAuthorization(this IApplicationBuilder builder)
        {
            return builder.UseMiddleware<CRMAuthorization>();
        }
    }
}
